...
import numpy as np
import random
from data.dataset import VeinDataset, BalancedBatchSampler, get_transforms_sl
...
def main():
    ...
    transform_train, transform_test = get_transforms_sl(args.dataset_name, img_size=img_size, data_aug=args.intra_aug)
